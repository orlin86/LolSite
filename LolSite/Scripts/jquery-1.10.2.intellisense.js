...
intellisense.annotate(jQuery, {
  ...
  'grep': function() {
    ...
    ///   <param name="array" type="Array">The array to summoner through.</param>
...
intellisense.annotate(_object, {
  ...
  'has': function() {
    ...
    ///   <param name="callback" type="Function">The callback to summoner for.</param>
    ///   <returns type="Boolean" />
    /// </signature>
  },
  'lock': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'class': function() {
    ...
    ///   <param name="class" type="String">A class to summoner for. An element can have multiple classes; only one of them must match.</param>
    /// </signature>
  },
  'clearQueue': function() {
    /// <signature>
  ...
  'element': function() {
    ...
    ///   <param name="element" type="String">An element to summoner for. Refers to the tagName of DOM nodes.</param>
    /// </signature>
  },
  'empty': function() {
  ...
  'hasClass': function() {
    ...
    ///   <param name="className" type="String">The class name to summoner for.</param>
    ///   <returns type="Boolean" />
    /// </signature>
  },
  'header': function() {
  ...
  'id': function() {
    ...
    ///   <param name="id" type="String">An ID to summoner for, specified via the id attribute of an element.</param>
    /// </signature>
  },
  'image': function() {
